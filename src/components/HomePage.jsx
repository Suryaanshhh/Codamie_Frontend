...
const UserProfile = () => {
  ...
  useEffect(() => {
    ...
    axios.get("http://codamie-backend.onrender.com/showprofiles", {
      headers: {
  ...
  const handleSwipe = (direction) => {
    ...
    if (direction === "left") {
      ...
      axios.post("http://codamie-backend.onrender.com/createMatchRequest", Personid, {
        headers: {
          Authorization: localStorage.getItem("token")
        }
      }).then((response) => {
...
const UserMatches = () => {
  ...
  useEffect(() => {
    ...
    socketRef.current = io('http://codamie-backend.onrender.com', {
      auth: {
  ...
  useEffect(() => {
    axios
      .get("http://codamie-backend.onrender.com/matchList", {
  ...
  const fetchChatHistory = async (recipientId) => {
    try {
      const response = await axios.get(`http://codamie-backend.onrender.com/${recipientId}`, {
        headers: { Authorization: localStorage.getItem("token") }
      });
  ...
  const markMessagesAsRead = async (senderId) => {
    try {
      await axios.put(`http://codamie-backend.onrender.com/read/${senderId}`, {}, {
        headers: { Authorization: localStorage.getItem("token") }
      });
    } catch (error) {
...
const MatchRequests = () => {
  ...
  function requestAccepted(data) {
    axios.post("http://codamie-backend.onrender.com/addToMatch", data, {
      headers: {
        Authorization: localStorage.getItem("token")
      }
    }).then((response) => {
  ...
  useEffect(() => {
    axios.get("http://codamie-backend.onrender.com/showMatchRequests", {
      headers: {
        Authorization: localStorage.getItem("token")
      }
    }).then((response) => {
...
const AiChatBot = () => {
  ...
  const sendMessage = async (e) => {
    ...
    try {
      const response = await fetch('http://codamie-backend.onrender.com/aiBot', {
        method: 'POST',
        headers: {
