...
const UserProfile = () => {
  ...
  useEffect(() => {
    ...
    axios.get("https://codamie-backend.onrender.com/showprofiles", {
      headers: {
  ...
  const handleSwipe = (direction) => {
    ...
    if (direction === "left") {
      ...
      axios.post("https://codamie-backend.onrender.com/createMatchRequest", Personid, {
        headers: {
          Authorization: localStorage.getItem("token")
        }
      }).then((response) => {
...
const UserMatches = () => {
  ...
  useEffect(() => {
    ...
    socketRef.current = io('https://codamie-backend.onrender.com', {
      auth: {
  ...
  useEffect(() => {
    axios
      .get("https://codamie-backend.onrender.com/matchList", {
  ...
  const markMessagesAsRead = async (senderId) => {
    try {
      await axios.put(`https://codamie-backend.onrender.com/read/${senderId}`, {}, {
        headers: { Authorization: localStorage.getItem("token") }
      });
    } catch (error) {
...
const MatchRequests = () => {
  ...
  function requestAccepted(data) {
    axios.post("https://codamie-backend.onrender.com/addToMatch", data, {
      headers: {
        Authorization: localStorage.getItem("token")
      }
    }).then((response) => {
  ...
  useEffect(() => {
    axios.get("https://codamie-backend.onrender.com/showMatchRequests", {
      headers: {
        Authorization: localStorage.getItem("token")
      }
    }).then((response) => {
