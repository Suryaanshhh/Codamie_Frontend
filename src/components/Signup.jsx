            ...
            <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
                ...
                <div className="p-8">
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            <button onClick={githubAuth} type="button" className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
